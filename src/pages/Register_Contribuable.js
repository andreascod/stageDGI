...
export default function Reg() {
  ...
  const handleRegister = async (e) => {
    ...
    formData.append('CIN',cinRef.current.value);
          ...
          <div className='w-full h-[400px] flex flex-col '>
            ...
            <form onSubmit={handleRegister}>
              ...
              <input
                  ...
                  placeholder='CIN'
                  required
                  className="mt-1 block my-[1rem] w-[50%] px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                />
                <input
                  type='text'
                  ref={nameRef}
                ...
                <input
                  ...
                  placeholder='Email'
                  required
                  className="mt-1 my-[1rem] block w-[50%] px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                />
                  <input
                  type='text'
                  ref={adresseRef}
                ...
                <select
                  ref={roleRef}
                  required
                  className='w-[47%] text-black bg-none border-b border-black outline-none focus:outline-none my-4'
                >
                ...
                <button
                  className='w-[47%] h-14 mx-[53%] text-white bg-[#336666] rounded-md text-center flex items-center justify-center my-6'
                  type='submit'
                >
                  Enregistrer
                </button>
